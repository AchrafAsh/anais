...
print(f"Occurences (once): {occurences[occurences == 1].count() / len(df.code.unique()):2.2%}") # 159 (70% of our dataset only appears once)
print(f"Occurences (3 or less): {occurences[occurences <= 3].count() / len(df.code.unique()):2.2%}") # 211 (93% appears three times or less)
